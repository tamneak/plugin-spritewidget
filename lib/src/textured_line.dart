...
class TexturedLine extends Node {
  ...
  TexturedLine(List<Offset> points, List<Color> colors, List<double> widths, {required SpriteTexture texture,required List<double> textureStops}) {
    painter = new TexturedLinePainter(points, colors, widths, texture: texture, textureStops: textureStops);
  }

  /// The painter used to draw the line.
  late TexturedLinePainter painter;
...
class TexturedLinePainter {
  ...
  TexturedLinePainter(this._points, this.colors, this.widths, {required SpriteTexture texture,this.textureStops}) {
